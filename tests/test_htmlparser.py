...
This code is a direct copy of the code found in Python 2.7.10 soource distribution.

It is intended for minor customizations as there are special/adversarial cases not
handled by known parser.
"""
